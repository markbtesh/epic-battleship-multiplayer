...
app.use(cors({
  origin: 'http://battleship.markbtesh.com/:4200',  // Allow requests from your Angular app
  ...
  const io = require('socket.io')(server, {
    cors: {
        origin: 'http://battleship.markbtesh.com/:4200',  // Allow socket connections from your Angular app
        methods: ['GET', 'POST'],
        credentials: true,
    }
});
