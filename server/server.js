...
app.use(cors({
  origin: 'https://epic-battleship-multiplayer-server-8afujv666.vercel.app:4200',  // Allow requests from your Angular app
  ...
  const io = require('socket.io')(server, {
    cors: {
        origin: 'https://epic-battleship-multiplayer-server-8afujv666.vercel.app:4200',  // Allow socket connections from your Angular app
        methods: ['GET', 'POST'],
        credentials: true,
    }
});
